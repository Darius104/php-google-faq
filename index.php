    ...
    <main>
        <div class="container">
            <?php foreach($data as $block) { ?>
                <h2 class="h2"> <?php echo $block['request'] ?> </h2>

                <?php foreach($block['answer'] as $element) { ?>
                    <?php if(!is_array($element)) { ?>
                        <p class="p" class="h4"> <?php echo $element ?> </p>

                    <?php } else { ?>
                        <?php foreach($element as $sub) { ?>
                            <?php if(!is_array($sub)) { ?>
                                <p class="p"><?php echo $sub ?></p>

                            <?php } ?>

                            <?php foreach($sub as $ultimo) { ?>
                                <p class="p" style="margin-left: 20px";><?php echo($ultimo) ?></p>
                            <?php } ?>
                        <?php } ?>
                    <?php } ?>
                <?php } ?>
